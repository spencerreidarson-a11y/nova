...
.modal-bg, .modal, .po-modal-bg, .po-modal, .wt-overlay, .wt-viewer, .wc-modal-bg, .wc-modal {
  overscroll-behavior: contain;
}
body.topbar-modal-open { overflow: hidden; touch-action: none; }
@media (max-width: 480px) {
  .modal-bg, .po-modal-bg, .wc-modal-bg {
    padding: 0 !important;
    align-items: stretch !important;
    justify-content: stretch !important;
  }
  .modal, .po-modal, .wc-modal {
    width: 100% !important;
...
<header class="topbar" id="topbar" role="navigation" aria-label="Quick stats">
  ...
  <a href="health.html" class="topbar-pill" id="topbarStack">
    ...
    <span class="topbar-pill-count" id="topbarStackCount">0/0</span>
  </a>
...
`;
  ...
  function defaultWaterState() {
    return { unit: 'bottle', bottleMl: 500, glassMl: 250, weightUnit: 'kg', profile: { weightKg: 75, age: 25, sex: 'm', activityHrsPerWeek: 5 }, caffeineMgPerDay: 200, substances: [], logs: {} };
  }
